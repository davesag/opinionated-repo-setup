# How to contribute to the Opinionated Repo Setup project
...
3. Set this repo as the `upstream` repo `git remote add upstream git@github.com:davesag/opinionated-repo-setup.git`
